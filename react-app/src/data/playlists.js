export const playlists = {
  happy: [
    { id: 1, title: "Sunday Morning", artist: "Maroon 5", duration: "3:05", audio: "/audio/happy/Maroon 5 - Sunday Morning (SPOTISAVER).mp3" },
    { id: 2, title: "Good Days", artist: "SZA", duration: "4:39", audio: "/audio/happy/SZA - Good Days (SPOTISAVER).mp3" },
    { id: 3, title: "Here's Where the Story Ends", artist: "The Sundays", duration: "3:58", audio: "/audio/happy/The Sundays - Here's Where The Story Ends (SPOTISAVER).mp3" },
    { id: 4, title: "Hot Rod", artist: "Dayglow", duration: "3:45", audio: "/audio/happy/Dayglow - Hot Rod (SPOTISAVER).mp3" },
    { id: 5, title: "Feather", artist: "Sabrina Carpenter", duration: "3:14", audio: "/audio/happy/Sabrina Carpenter - Feather (SPOTISAVER).mp3" },
    { id: 6, title: "Summer", artist: "Housecall", duration: "3:03", audio: "/audio/happy/Housecall - Summer (SPOTISAVER).mp3" },
    { id: 7, title: "New Light", artist: "John Mayer", duration: "3:05", audio: "/audio/happy/John Mayer - New Light (SPOTISAVER).mp3" },
    { id: 8, title: "Still into You", artist: "Paramore", duration: "3:40", audio: "/audio/happy/Paramore - Still into You (SPOTISAVER).mp3" },
    { id: 9, title: "Tongue Tied", artist: "GROUPLOVE", duration: "3:39", audio: "/audio/happy/GROUPLOVE - Tongue Tied (SPOTISAVER).mp3" },
    { id: 10, title: "Honey", artist: "Vacations", duration: "2:20", audio: "/audio/happy/Vacations - Honey (SPOTISAVER).mp3" },
    { id: 11, title: "Italo Disco", artist: "Last Dinosaurs", duration: "3:50", audio: "/audio/happy/Last Dinosaurs - Italo Disco (SPOTISAVER).mp3" },
    { id: 12, title: "Tek It", artist: "Cafune", duration: "3:30", audio: "/audio/happy/Cafuné - Tek It (SPOTISAVER).mp3" },
    { id: 13, title: "Sunny Day", artist: "beabadoobee", duration: "2:40", audio: "/audio/happy/wave to earth - sunny days (SPOTISAVER).mp3" },
    { id: 14, title: "peach eyes", artist: "wave to earth", duration: "3:05", audio: "/audio/happy/wave to earth - peach eyes (SPOTISAVER).mp3" },
  ],
  sad: [
    ...
    { id: 5, title: "Sunsetz", artist: "Cigarettes After Sex", duration: "3:35" },
